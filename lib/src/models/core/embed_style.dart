...
class EmbedStyle extends Equatable {
  ...
  /// Optional background color for the WebView wrapper. If null, the fallback is
  /// usually [ThemeData.scaffoldBackgroundColor].
  ...
  List<Object?> get props =>
      [borderRadius, maxScrollableHeight, backgroundColor];
