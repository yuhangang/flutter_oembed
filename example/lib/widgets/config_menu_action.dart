                  ...
                  children: [
                    ...
                    _buildSection(
                      ...
                      child: Column(
                        ...
                        children: [
                          SwitchListTile(
                            title: const Text('Override Preferred Height'),
                            subtitle: Text(
                              settings.preferredEmbedHeight == null
                                  ? 'Use provider defaults and dynamic sizing'
                                  : 'Fixed at ${settings.preferredEmbedHeight!.round()} px for all EmbedCard examples',
                            ),
                            value: settings.preferredEmbedHeight != null,
                            onChanged: (enabled) {
                              controller.updatePreferredEmbedHeight(
                                enabled
                                    ? (settings.preferredEmbedHeight ?? 232)
                                    : null,
                              );
                              setState(() {});
                            },
                          ...
                          if (settings.preferredEmbedHeight != null) ...[
                            const SizedBox(height: 8),
                            Text(
                              'Height: ${settings.preferredEmbedHeight!.round()} px',
                              style: theme.textTheme.bodyMedium?.copyWith(
                                fontWeight: FontWeight.w600,
                              ),
                            ),
                            Slider(
                              value: settings.preferredEmbedHeight!,
                              min: 120,
                              max: 480,
                              divisions: 18,
                              label:
                                  '${settings.preferredEmbedHeight!.round()} px',
                              onChanged: (value) {
                                controller.updatePreferredEmbedHeight(value);
                                setState(() {});
                              },
                            ),
                            Wrap(
                            ...
                            const SizedBox(height: 8),
                            Text(
                              'Applies to the standard EmbedCard examples. Native TikTok and YouTube player demos keep their own aspect-ratio sizing.',
